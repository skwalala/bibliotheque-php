...
<td>".$auteur['prenomAuteur']."</td><td>".$auteur['count']."</td>
<td><a href='Auteur_edit.php?auteur=".$auteur['idAuteur']."&nom='".$auteur['nomAuteur']."'&prenom='".$auteur['prenomAuteur']."''>modifier</a> <a href='Auteur_delete.php?auteur=".$auteur['idAuteur']."'>supprimer</a></td>";
	echo "</tr>";
    }
    ?>
    	</tbody>
